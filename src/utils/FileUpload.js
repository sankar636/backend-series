...
const uploadOnCloudinary = async (localFilePath) => {
    try {
        ...
        console.log("File uploaded successifully on cloudinary", response.url);        
        return response
    } catch (error) {
        console.log("Error in uploading the file", error);  
        fs.unlinkSync(localFilePath) // this removes the locally saved file as the upload operation failed for this temporary file
        return null      
    }
}
